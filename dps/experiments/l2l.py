...
class LearningToLearn(TensorFlowEnv):
    ...
    def __init__(self, **kwargs):
        ...
        self.rb = RegisterBank('L2LRB', 'x y vision action', None, [0.0, 0.0, -1.0, 0.0], 'x y')
    ...
    def _make_input(self, batch_size):
        start_x = np.zeros((batch_size, 1))
        start_y = np.zeros((batch_size, 1))
