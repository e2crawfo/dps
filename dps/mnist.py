...
def train_mnist(build_model, var_scope, path=None):
    ...
    train_dataset = TranslatedMnistDataset(
        28, 1, np.inf, cfg.n_train, symbols=cfg.symbols, include_blank=cfg.include_blank)
    val_dataset = TranslatedMnistDataset(
        28, 1, np.inf, cfg.n_val, for_eval=True, symbols=cfg.symbols, include_blank=cfg.include_blank)
    obs_dim = 28 ** 2
